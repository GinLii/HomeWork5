...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("15336543628", "lijuns", coverImagePart, videoPart).enqueue(
    ...
    public void fetchFeed(View view) {
        ...
        mDisplay = findViewById(R.id.btn_myid);
        int flag = 1;
        miniDouyinService.getVideos().enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    final List<Video> nVideos=new ArrayList<>();
                    for (int i = 0; i < mVideos.size(); i++){
                        if (mVideos.get(i).studentId.equals("15336543628")){
                            nVideos.add(mVideos.get(i));
                        }
                    }
